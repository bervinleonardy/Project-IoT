...
//        if (type === 'marker') {
//            layer.bindPopup('Marker Reservoir');
//			console.log("coord Marker: "+e.layer.toGeoJSON().geometry.coordinates);
//        }
//        if (type === 'polygon'){
//        	console.log("coord Polygon : "+e.layer.toGeoJSON().geometry.coordinates);
//        }
//        if (type === 'polyline'){
//        	console.log("coord Polyline : "+e.layer.toGeoJSON().geometry.coordinates);
//        }			
//
...
//			console.log("Shape : ", shapes);
		...
		var getShapes = function (editableLayers) {
			...
			editableLayers.eachLayer(function (layer) {
				...
				if (layer instanceof L.Polyline) {
					shapes["polyline"].push([layer.toGeoJSON().geometry.coordinates]);
					console.log("Shape Polyline: ", layer.toGeoJSON().geometry.coordinates);
				}

				if (layer instanceof L.Polygon) {
					shapes["polygon"].push([layer.getLatLng()]);
				}
			...
			jQuery.ajax({type: 'GET', url: urls, dataType: 'json',
				success: function(v){
					for(i in v){
						...
						updateMarkerStatus(v[i].id, v[i].pipa_retikulasi_awal, v[i].pipa_retikulasi_akhir, v[i].pipa_dinas_awal, v[i].pipa_dinas_akhir, v[i].tekanan_reservoir, v[i].volume_reservoir, v[i].latitude, v[i].longitude, v[i].waktu,v[i].tanggal);
...
//							console.log("JSON SUKSES: " + updateMarkerStatus);
        ...
        function updateMarkerStatus(id, pipa_retikulasi_awal, pipa_retikulasi_akhir,pipa_dinas_awal, pipa_dinas_akhir, tekanan_reservoir,volume_reservoir, latitude, longitude, waktu, tanggal){
			...
			'<div class="card card-danger"> \
				...
				<div class="card-body">\
					...
					<div>Debit Pipa Dinas Awal   :'+pipa_dinas_awal+' Liter/detik</div>\
					<div>Debit Pipa Dinas Akhir  :'+pipa_dinas_akhir+' Liter/detik</div>\
			...
			'<div class="card card-success"> \
			  ...
			  <div class="card-body">\
						...
						<div>Volume Reservoir  : '+volume_reservoir+' Liter </div>\
						<div >Tekanan Air Reservoir : '+tekanan_reservoir+' PSi</div>\
						<div >Status Reservoir : Berbahaya ! </div>\
			  </div>\
				<div></div> \
			</div>';
